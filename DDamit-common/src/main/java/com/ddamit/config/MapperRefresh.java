...
public class MapperRefresh implements Runnable {
    ...
    private static String filename = "setting.properties";
    ...
    static {
        ...
        String value = getPropString("mybatis-refresh.enabled");
        System.out.println(value);
        enabled = "true".equalsIgnoreCase(value);

        delaySeconds = getPropInt("mybatis-refresh.delaySeconds");
        sleepSeconds = getPropInt("mybatis-refresh.sleepSeconds");
        mappingPath = getPropString("mybatis-refresh.mappingPath");
